...
public class QuickStartLobbyController : MonoBehaviourPunCallbacks
{
    ...
    [SerializeField]
    private int RoomSize=2; //Manual set the number of player in the room at one time.
    ...
    void CreateRoom() //trying to create our own room
    {
        ...
        //PhotonNetwork.CreateRoom(null);//"Room" + randomRoomNumber, roomOps); //attempting to create a new room
        PhotonNetwork.CreateRoom("Room" + randomRoomNumber, new RoomOptions() { MaxPlayers = (byte)RoomSize }, null);
